...
private:
	...
	bool checkHorizontal(Word word, unsigned short rowIndex, unsigned short collumnIndex);
	bool checkVertical(Word word, unsigned short rowIndex, unsigned short collumnIndex);
